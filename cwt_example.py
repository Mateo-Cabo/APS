...
t, signal = generar_senal(f1=10., f2=100., center1=0.25, center2=0.75, width1=0.05, width2=0.05, N = N, fs = fs) #definir la plantilla
...
coeffs = pywt.wavedec(ecg_signal, wavelet, level=15)

# Separar coeficientes

# for i in c:
#     c = coeffs
cA15, cD15, cD14, cD13, cD12, cD11, cD10, cD9, cD8, cD7, cD6, cD5, cD4, cD3, cD2, cD1 = coeffs
